...
# La tasa crece a a partir de los 16 años llegando a su maximo al rededor,
# de los 26 y luego comienza a descender, teniendo incluso un cambio de 
# concavidad, la tasa se construye con (n*B*x) / (n*W*x)
# n = tamaño del intervalo, B = nacim asoc a mujeres en intervalo [x, x+n]
# W = nro de mujeres con edad en el intervalo [x, x+n]
...
# En id identificamos cual es cada mujer, nac vemos cuantos hijos tuvo, en 
# paridad nos muestra el orden y en edad a que edad lo tuvo exactamente
