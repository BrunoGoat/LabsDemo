...
# Testear la función:
# El profe cambio esto a 0.5 y ahi se ven iguales las barras
lambda <- 1
n <- 10^6
samples <- generate_exponential(n, lambda)
...
# Tenemos unas observaciones iniciales, que no sabemos como distribuyen, le aplicamos la función inversa,
# y con eso recuperamos la densidad original

# Aplicamos la inversa y a la funcion acumulada de la exponencial y 
# obtenemos los valores de x a una exponencial
